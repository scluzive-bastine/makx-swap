...
const Desktop: FC = () => {
  ...
  return (
    <>
      <header className="fixed z-20 hidden w-full lg:block py-2" style={{ height: HEADER_HEIGHT }}>
        <nav className={NAV_CLASS}>
          <Container maxWidth="full" className="mx-auto">
            <div className="flex items-center justify-between gap-4 px-6">
              ...
              <div className="flex items-center justify-end w-auto space-x-2 select-none whitespace-nowrap">
                {/* {account && chainId && (
